    ...
    <div className="w-96">
        ...
        <CustomInput
          ...
          suffix={
            <ToggleButtonGroupCustom
              name="url"
              alignment={
                authData?.oauth?.postOrGet?.toLowerCase() || alignment?.["url"]
              }
              handleChange={handleChange}
              options={[
                { value: "get", label: "GET" },
      ...
      {!validationIssues && (
        <div className="flex gap-3">
          {isLoading ? (
            <CustomLoader
              iconClassName="icon-pink-1"
              labelClassName="text-secondary-pink-light-1"
              label="Authenticating your API...."
            />
          ) : (
