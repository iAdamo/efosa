...
function ApiAuthentication() {
  ...
  return (
    <div className="h-full w-full p-6 flex flex-col gap-6 bg-transparent">
      {!isEditMode?.editApi1 && authMethodKey?.api1 && activeTabAPI1 ? (
        <div className="flex flex-col mt-14 px-6 gap-8 justify-center ml-72">
          ...
          {activeTabAPI1 === "JWT" && (
            <div>
              <JWTForm
                ...
                MuiInputBaseStyles={MuiInputBaseStyles}
              />
              <Button onClick={() => handleCloseEditMode("editApi1")}>
                Close
              </Button>
            </div>
          )}
        ...
        <div className="flex flex-col mt-14 ml-72 px-6 gap-8 justify-center">
        ...
        <div className="flex flex-row w-[40rem] mt-20 ml-48 gap-6 justify-center">
          ...
          <div className="w-4/5 flex flex-col gap-6">
            ...
            <div>
              ...
              <p className="text-[12px] text-specc-neutral3">
              ...
              {apiTabs1.map(({ name, icon: Icon, tabKey }) => (
                ...
                >
                  <div className="flex gap-[10px] items-center">
                    <span className="hover:text-white font-medium">{Icon}</span>
          ...
          <div className="flex items-center gap-36">
            <div className="flex flex-col flex-1 gap-2">
              ...
              <span className="font-normal text-base text-grey-17">
                With your APIs selected, authenticate them to enable secure data
                flow and start building your integration.
              </span>
            </div>
            <div>
              <Button
