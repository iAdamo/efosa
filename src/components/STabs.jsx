...
export default function STabs({ ...props }) {
  ...
  const renderChildAndSibling = () => {
    ...
    if (props.childWithSibling)
      return (
        <div className={props.childWithSibling}>
          <TabListBody />
  ...
  return (
    ...
    >
      <div
        className={`flex flex-row gap-3 flex-none w-full ${props.tabStyles?.tabChild || ""}`}
      >
        <TabList
          aria-label="Dynamic tabs"
          items={props.tabs}
